        ...
        "/inspectplans/{name}/status": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "{status:{lastTaskStatus:‘’}}",
                        "name": "status",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1alpha2.InspectPlanStatus"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/v1alpha2.InspectResult"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "v1alpha2.InspectPlan": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha2.InspectPlanSpec"
                },
                "status": {
                    "$ref": "#/definitions/v1alpha2.InspectPlanStatus"
                }
        ...
        "v1alpha2.InspectPlanSpec": {
            ...
            "properties": {
                ...
                "ruleNames": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.InspectRuleNames"
                    }
                },
                "schedule": {
                    "type": "string"
        ...
        "v1alpha2.InspectResult": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha2.InspectResultSpec"
                },
                "status": {
                    "$ref": "#/definitions/v1alpha2.InspectResultStatus"
                }
            }
        },
        "v1alpha2.InspectResultSpec": {
            ...
            "properties": {
                ...
                "opaResult": {
                    "$ref": "#/definitions/v1alpha2.KubeeyeOpaResult"
                },
                "prometheusResult": {
                    "type": "array",
                    "items": {
                ...
                "serviceConnectResult": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.ServiceConnectResultItem"
                    }
                },
                "sysctlResult": {
                    "type": "array",
        ...
        "v1alpha2.InspectRule": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha2.InspectRuleSpec"
                },
                "status": {
                    "$ref": "#/definitions/v1alpha2.InspectRuleStatus"
                }
            }
        },
        "v1alpha2.InspectRuleNames": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "v1alpha2.InspectRuleSpec": {
            ...
            "properties": {
                ...
                "fileChange": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.FileChangeRule"
                    }
                },
                "fileFilter": {
                    "type": "array",
                ...
                "nodeInfo": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.NodeInfoRule"
                    }
                },
                "opas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.OpaRule"
                    }
                },
                "prometheus": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.PrometheusRule"
                    }
                },
                "prometheusEndpoint": {
                    "type": "string"
                ...
                "serviceConnect": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.ServiceConnectRule"
                    }
                },
                "sysctl": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.SysRule"
                    }
                },
                "systemd": {
                    "type": "array",
        ...
        "v1alpha2.InspectTask": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha2.InspectTaskSpec"
                },
                "status": {
                    "$ref": "#/definitions/v1alpha2.InspectTaskStatus"
                }
            }
        },
        "v1alpha2.InspectTaskSpec": {
            "type": "object",
            "properties": {
                "clusterName": {
                    "type": "array",
        ...
        "v1alpha2.KubeeyeOpaResult": {
            "type": "object",
            "properties": {
                "extraInfo": {
                    "$ref": "#/definitions/v1alpha2.ExtraInfo"
                },
                "percent": {
                    "type": "integer"
                },
                "resourceResults": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.ResourceResult"
                    }
                },
                "scoreInfo": {
                    "$ref": "#/definitions/v1alpha2.ScoreInfo"
                }
            }
        },
        "v1alpha2.Level": {
        ...
        "v1alpha2.NodeInfoResultItem": {
            ...
            "properties": {
                ...
                "resourcesType": {
                    "$ref": "#/definitions/v1alpha2.ResourcesType"
                },
                "value": {
                    "type": "string"
                }
        ...
        "v1alpha2.ResourceResult": {
            ...
            "properties": {
                ...
                "resultItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha2.ResultItem"
                    }
                }
            }
        },
        "v1alpha2.ResourcesType": {
            "type": "object",
            "properties": {
                "mount": {
                    "type": "string"
        ...
        "v1alpha2.ServiceConnectResultItem": {
            "type": "object",
            "properties": {
                "assert": {
                    "type": "boolean"
